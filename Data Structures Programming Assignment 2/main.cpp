...
#include "sequence3d.h"  // Provides the sequence class with double items.
using namespace std;
...
const char DESCRIPTION[MANY_TESTS+1][256] = {
    ...
    "Testing insert, append, and the constant member functions",
    "Testing situations where the cursor goes off the sequence",
    "Testing remove_current",
    "Testing the copy constructor",
    "Testing the assignment operator",
    "Testing insert/append for somewhat larger sequences"
    "Testing retreat"
};
...
// **************************************************************************
// int test1( )
//   Performs some basic tests of insert, append, and the constant member
...
int test1( )
{
    ...
    // Test the append function to add something to an empty sequence
    cout << "I am now using append to put 10 into an empty sequence." << endl;
    test.append(10);
    ...
    cout << "I am now using append to put 10,20,30 in an empty sequence.\n";
    ...
    // Test the append function to add an item in the middle of a sequence
    cout << "I am now using append to put 10,20,30 in an empty sequence.\n";
    cout << "Then I move the cursor to the start and append 15 ";
...
//   of the sequence. Also tests that append/insert work correctly when there is
...
int test2( )
{
    ...
    cout << "Using append to put 20 and 30 in the sequence, and then calling\n";
    ...
    // append more items until the sequence becomes full.
    // Note that the first append should append to the end of the sequence.
    cout << "Calling append to put the numbers 40, 50, 60 ...";
...
int test3( )
{
    ...
    cout << "Using append to build a sequence with 10,30." << endl;
    test.append(10);
    test.append(30);
    ...
    cout << "Using append to build another sequence with 10,30." << endl;
    test.append(10);
    test.append(30);
    cout << "Insert a 20 before the 30, so entire sequence is 10,20,30." << endl;
    test.insert(20);
...
int test4( )
{
    ...
    original.append(1); // Changes the original sequence, but not the copy.
...
// **************************************************************************
// int test6( )
//   Performs some basic tests of insert and append for the case where the
...
int test6( )
{
    ...
    cout << "Testing to see that append works correctly when the\n";
...
int test7( )
{
    ...
    // Put three items in the sequence
    cout << "Using append to put 20 and 30 in the sequence, and then calling\n";
    cout << "retreat twice, so that is_item should return false ... ";
    cout.flush( );
    test.append(20);
    test.append(30);
    test.retreat( );
...
int main( )
{
    ...
    cout << sum << " out of " << POINTS[0];
    cout << " as the test score .\n";
